...
// console.log(carMarket.getCustomerByName("Nikita Philip"));
// console.log(carMarket.getCustomerIdByName("Nikita Philip"));
...
// console.log(carMarket.customers[0].cars);
// carMarket.deleteCarFromAgency("oqQmsZoUo", "sZrjp");
// console.log(carMarket.sellers[4].cars[0]);
